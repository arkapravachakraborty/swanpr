...
// a function that shows the submit button components
function SubmitButton() {
    // from the hook take the pending status
    ...
    // user cliked and it processing it
    if (pending) {
...
type GithubSignInFormProps = {
    // post loging callback redirecting path optional
    // used for searchParams in sign-in/page.tsx
    callbackUrl?: string
};
